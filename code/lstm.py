...
GLOVE_FILE = '../dataset/glove.twitter.27B/glove.twitter.27B.200d.txt'
dim = 200
...
def get_glove_vectors(vocab):
    ...
    glove_vectors = {}
    found = 0
    with open(GLOVE_FILE, encoding='utf-8') as glove_file:
...
if __name__ == '__main__':
    ...
    if train:
        ...
        filepath = "./models/lstm-{epoch:02d}-{loss:0.3f}-{accuracy:0.3f}-{val_loss:0.3f}-{val_accuracy:0.3f}.hdf5"
